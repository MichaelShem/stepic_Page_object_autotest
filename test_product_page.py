...
class TestQuestAddToBasketFromProductPage():
    @pytest.mark.parametrize('link_end', ["?promo=offer0",
                                      "?promo=offer1",
                                      "?promo=offer2",
                                      "?promo=offer3",
                                      "?promo=offer4",
    ...
    def test_guest_can_add_product_to_basket(self, browser, link_end):
        link = f"http://selenium1py.pythonanywhere.com/catalogue/coders-at-work_207/{link_end}"
